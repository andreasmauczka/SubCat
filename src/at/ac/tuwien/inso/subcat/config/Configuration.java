...
public class Configuration {
	...
	public void setTeamViewConfig (TeamViewConfig teamViewConfig) {
		assert (teamViewConfig != null);

		this.teamViewConfig = teamViewConfig;
	}

	public ProjectViewConfig getProjectViewConfig () {
		return projectViewConfig;
	}

	public void setProjectViewConfig (ProjectViewConfig projectViewConfig) {
		assert (projectViewConfig != null);

		this.projectViewConfig = projectViewConfig;
	}
