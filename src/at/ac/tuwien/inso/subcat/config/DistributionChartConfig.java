...
public class DistributionChartConfig extends ChartGroupConfig {
	...
	public DistributionChartConfig (String name, SourcePos start, SourcePos end) {
		...
		options = new LinkedList<DistributionChartOptionConfig> ();
	}
	
	public void addOption (DistributionChartOptionConfig option) {
		assert (option != null);

		options.add (option);
	}
	
	public List<DistributionChartOptionConfig> getOptions () {
		return options;
	}
	...
	public void accept (ConfigVisitor visitor) {
		...
		visitor.visitDistributionChartConfig (this);
	}
	...
	public void acceptChildren (ConfigVisitor visitor) {
		...
		for (DistributionChartOptionConfig opt : options) {
			opt.accept (visitor);
		}
	}
}
